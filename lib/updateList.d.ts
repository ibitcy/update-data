 ...
 * @param {function} matchFn - The function to match old array items with new ones to check they are the same records (for example by id field)
 ...
 */
export declare function updateList<T>(listOld: T[], listNew: T[], matchFn: (itemOld: T, nitemNew: T) => boolean, competeFn?: (itemOld: T, itemNew: T) => boolean): T[];
